    ...
    stages {
        ...
        stage('Another start on Server') {
            steps {
                ...
                sh "ssh -o StrictHostKeyChecking=no -i ${env.SERVER_LOGIN} ${params.SSH_USER}@${params.SERVER_FQDN} 'wget https://raw.githubusercontent.com/schumad/ci-cd-test/main/Dockerfile'"
